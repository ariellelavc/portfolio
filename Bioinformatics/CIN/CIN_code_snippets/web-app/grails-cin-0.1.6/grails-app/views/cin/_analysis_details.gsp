	...
	<div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
		<div class="ui-jqgrid-view">
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
				...
				<span class="ui-jqgrid-title"><g:message code="cin.results"/></span>
			</div>
		</div>
	</div>
	...
	<table width="100%" >
		<g:each in="${it.query}" var="data">
			<tr>
				...
				<g:else>
					<td class="ui-widget-content" id="${data.key.decamelize()}" style="padding: 2px;" >
						<g:if test="${(data.key == 'baselineGroup') || (data.key == 'groups')}">
							${g.listNameForId(data.value)}<br/>
						</g:if>
						<g:else>
							${data.value}
						</g:else>

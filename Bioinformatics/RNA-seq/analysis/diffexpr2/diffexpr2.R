...
## ---- message=FALSE, warning=FALSE-----------------------------------------------------------------------------------------------------------------------------------------
#library(pathview)
path.view.out.list <- sapply(path.ids[1:3], 
                             function(pid) pathview(gene.data = expr.fc, pathway.id = pid,
...
cnetplot(edox, foldChange=expr.fc.desc.order, circular = TRUE, colorEdge = TRUE, 
         showCategory = 4) 
cnetplot(edox, foldChange=expr.fc.desc.order, circular = TRUE, colorEdge = TRUE, 
         showCategory = 1)
cnetplot(edox, foldChange=expr.fc.desc.order, circular = TRUE, colorEdge = TRUE, 
         showCategory = 'cell type cancer') 
